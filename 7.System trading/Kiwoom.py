...
if __name__ == "__main__":
    ...
    # kiwoom.set_input_value("계좌번호", "8133703211")
    # kiwoom.set_input_value("비밀번호", "4879")
    ...
    kiwoom.set_input_value("종목코드", "102110")
    kiwoom.comm_rq_data("opt10001_req", "opt10001", 0, "2000")
    print(kiwoom.now_price)
